  ...
  return (
    <>
      <div className="mb-2 leading-relaxed mt-8 flex justify-center items-center">
        ...
        <div className=" flex flex-row justify-center items-center">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="flex text-white sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 ">
            <svg
              fill="currentColor"
              strokeLinecap="round"
          ...
          <a
            ...
            className="text-white sm:ml-4 sm:pl-4 sm:py-2 sm:mt-0"
            target="_blank"
            rel="noreferrer">
            <svg
              fill="none"
      ...
      <div className=" flex flex-row justify-center items-center mb-2">
        <Link
          className="flex  items-center md:justify-start justify-center text-gray-400 ml-3 text-xs hover:line-clamp-2"
