					...
					<div className='w-full space-y-12 lg:w-1/2 xl:w-1/2'>
						...
						<motion.div
                            ...
                            <div className="mt-1 md:mx-4 md:mt-0">
                                <h1 className="text-xl text-gray-700 dark:text-white">El desarrollo de emprendimientos inmobiliarios de primer nivel</h1>
                            </div>
                        </motion.div>
						...
						<motion.div
                            ...
                            <div className="mt-1 md:mx-4 md:mt-0">
                                <h1 className="text-xl text-gray-700 dark:text-white">Con materiales y detalles ùnicos</h1>
                            </div>
                        </motion.div>
                        <motion.div 
                         initial="hidden"
