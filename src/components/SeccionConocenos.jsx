...
const SeccionConocenos = () => {
	return (
		<section className='md:h-full lg:h-screen xl:h-screen flex w-full items-center justify-center overflow-hidden bg-black/20'>
				...
				<div className='lg:flex lg:items-center xl:flex xl:items-center'>
					<div className='w-full space-y-12 lg:w-1/2 xl:w-1/2'>
						...
						<div>
							<motion.h1
								...
								className='text-xl font-semibold text-gray-800 lg:text-4xl xl:text-4xl dark:text-white'>
								Focalizamos nuestro
								<br /> trabajo en:
							</motion.h1>
						...
						<motion.div
							...
							<div className='mt-1 md:mx-4 md:mt-0'>
								<h1 className='text-2xl text-gray-700 dark:text-white'>
									La fabricación de productos industriales
								</h1>
							</div>
						</motion.div>
						...
						<motion.div
							...
							<div className='mt-1 md:mx-4 md:mt-0'>
								<h1 className='text-2xl text-gray-700 dark:text-white'>
									El desarrollo de emprendimientos inmobiliarios
								</h1>
							</div>
						</motion.div>
						<motion.div
							...
							<div className='mt-1 md:mx-4 md:mt-0'>
								<h1 className='text-2xl text-gray-700 dark:text-white'>
									La aplicación del sistema “Steel Framing”
								</h1>
							</div>
						</motion.div>
						<motion.div
							...
							<Link
								to='/ConocenosPage'
								className='inline-block rounded text-2xl hover:text-blue-400 transition-colors duration-300'>
								<b>Ver más...</b>
							</Link>
							<span className='inline-block w-3 h-1 ml-1 rounded-full bg-AceroCorp'></span>
							<span className='inline-block w-1 h-1 ml-1 rounded-full bg-AceroCorp'></span>
					...
					<div className='hidden lg:flex lg:items-center lg:w-1/2 lg:justify-center xl:flex xl:items-center xl:w-1/2 xl:justify-center'>
						<motion.img
							...
							className='w-[26rem] h-[26rem] object-cover xl:w-[34rem] xl:h-[34rem] rounded-full'
							src='../imagenes/Obras/Obra_villavagon.jpg'
							alt=''
						/>
					</div>
				</div>
