            ...
            <div className="container px-6 py-10 mx-auto">
                <div className="lg:flex lg:items-center">
                    <div className="w-full space-y-12 lg:w-1/2 ">
                        ...
                        className="mt-4">
                            <span className="inline-block w-40 h-1 rounded-full bg-AceroCorp"></span>
                            <Link to="/ConocenosPage" className="inline-block text-dark rounded text-2xl hover:text-blue-500 transition-colors duration-300"><b>Ver más...</b></Link>
                            <span className="inline-block w-3 h-1 ml-1 rounded-full bg-AceroCorp"></span>
                            <span className="inline-block w-1 h-1 ml-1 rounded-full bg-AceroCorp"></span>
                        </motion.div>
                    </div>
                    <div className="hidden lg:flex lg:items-center lg:w-1/2 lg:justify-center">
                        ...
                        className="w-[26rem] h-[26rem] object-cover xl:w-[34rem] xl:h-[34rem] rounded-full" src="../imagenes/Obras/Obra_villavagon.jpg" alt="" />
                    </div>
                </div>
            </div>
        </section>
